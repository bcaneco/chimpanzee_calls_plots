...
This repository contains **R** code developed during the analysis underpinning
...
the final manuscript, specifically in Figures 3-6.

To ensure reproducibility, this README provides a usage guide and references the
necessary scripts to generate these plots.Brief descriptions of each
visualization are also provided for clarity and context.


### Data

Data used for this analysis is provided in the **csv** file and consists of acoustic
...
Briefly, we consider two types of plots
- Directional plots (Fig. 4 in manuscript): 
