...
depicting sequences of recorded calls. Calls are binned into a 2D grid of cells,
each representing intervals of selected acoustic metrics. The plots illustrate
transitions in acoustic features between consecutive calls, offering two
variants: Spokes plots and Tracks plots.
...
To recreate these figures, run the script [panels_pizza.r](R/panels_pizza.R)
