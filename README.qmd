...
cells, each representing intervals of variables of interest. The plots allow to 
...
consecutive calls. For a given sequence of calls, acoustic differentials are
